...
import org.jboss.query.api.MethodQuery;
 ...
 * @version $Revision: $
 */
public abstract class AbstractMethodQueryTest<RESULT, INPUT, QUERY extends MethodQuery<? extends QUERY, INPUT, ?, RESULT>> 
      extends AbstractQueryTest<RESULT, INPUT, QUERY>
{
   @Test
   public void shouldMatchOnType() throws Exception
   {
      validate(createTypeQuery(Cat.class), "getMother", "getFather");
   }
